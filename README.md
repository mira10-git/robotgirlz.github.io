...
| ---------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| *SRS-01*                         | The temperature sensor shall operate and report values every 1 second.                                                                 | Confirmed. The IR temperature sensor starts and completes the 3 measurements necessary for an object temperature reading in < 100ms, as seen in the image below.                                                                                                                                                                                |
...
| *SRS-04*                         | The audio processor shall store and play up to 4 pre-recorded 10-second audio files, with playback starting ≤1 second after trigger. | Confirmed. a signal comes through the speaker at 180ms after GPIO trigger, as seen in the image below.                                                                                                                                                                                                                                                              |
| |                                                                                                                                        |                                                                                                                                                                                                                                                                                                                                                                                        |
...
| HRS-03 | A speaker shall emit an audible alert of at least 60 dB.                                                                                                                                                              | Confirmed. The reminder is audible! The video showing it can be visible here: images/Audio_Test.mov                                                                                                                                                                                                                                                                                                                                             |
| HRS-04 | A bright display shall display water temperature and amount of water drank legibly under typical indoor lighting                                                                                                      | Confirmed. The screen is bright and visible. The image confirming this can be seen here: images/HAPPY.jpeg                                                                                                                                                                                                                                                                                                                                      |
