...
![alt text](<images/tempmeasurements taken in under a seond.png>)
...
| *SRS-04*                         | The audio processor shall store and play up to 4 pre-recorded 10-second audio files, with playback starting ≤1 second after trigger. | Confirmed. a signal comes through the speaker at 180ms after GPIO trigger. Confirmation of the audio timing is seen here:                                                                                                                                                                                                                                                              |
