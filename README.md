...
| HRS-03 | A speaker shall emit an audible alert of at least 60 dB.                                                                                                                                                              | Confirmed. The reminder is audible! The video showing it can be visible is below.  images/Audio_Test.mov                                                                                                                                                                                                                                                                                                                                             |
...
### HRS images 
HRS-03 Audio verification: 
<video controls src="images/audioplayvideo.mp4" title="Title"></video>

HRS-04 Display verification:

<p style="display: flex; justify-content: center; gap: 30px;">
  <img src="images/HAPPY.jpeg" width="800">
</p>
